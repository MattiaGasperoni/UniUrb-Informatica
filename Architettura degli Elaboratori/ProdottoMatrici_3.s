...
loop:   
		...
		MUL.D   f3, f3, f4      ; a[i] * b[i]
        ADD.D   f0, f1, f3      ; p = p + a[i] * b[i] (risultato parziale)
		S.D     f0, 0(r3)       ; salva il risultato 
        MUL.D   f0, f0, f5      ; resetta il risultato parziale

puntatori:	
		DADDI   r3, r3, 8		; scorri registro risultati di C
		DADDI   r2, r2, 8		; punta alla nuova collonna di B
